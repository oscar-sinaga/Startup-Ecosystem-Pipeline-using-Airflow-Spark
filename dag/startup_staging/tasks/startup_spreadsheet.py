...
def startup_spreadsheet():
    ...
    def extract():
        ...
        table_to_extract = eval(Variable.get('list_startup_table_spreadsheet'))
        source = 'startup_spreadsheet'
    ...
    def load():
        ...
        table_to_load = eval(Variable.get('list_startup_table_spreadsheet'))
        table_pkey = eval(Variable.get('pkey_startup_table_spreadsheet'))
        source = 'startup_spreadsheet'
        previous_task = None
